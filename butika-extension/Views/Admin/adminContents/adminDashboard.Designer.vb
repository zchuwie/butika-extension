...
Partial Class adminDashboard
    ...
    Private Sub InitializeComponent()
        ...
        alluserShow = New Guna.UI2.WinForms.Guna2Button()
        Guna2Button1 = New Guna.UI2.WinForms.Guna2Button()
        customerNum = New Label()
        Label1 = New Label()
        Guna2Panel2 = New Guna.UI2.WinForms.Guna2Panel()
        activeShow = New Guna.UI2.WinForms.Guna2Button()
        Guna2Button2 = New Guna.UI2.WinForms.Guna2Button()
        activeNum = New Label()
        Guna2Panel3 = New Guna.UI2.WinForms.Guna2Panel()
        discountShow = New Guna.UI2.WinForms.Guna2Button()
        Guna2Button3 = New Guna.UI2.WinForms.Guna2Button()
        pendingNum = New Label()
        Guna2Panel4 = New Guna.UI2.WinForms.Guna2Panel()
        signupShow = New Guna.UI2.WinForms.Guna2Button()
        ...
        userActTable = New Guna.UI2.WinForms.Guna2DataGridView()
        Label13 = New Label()
        Label11 = New Label()
        Guna2Panel7 = New Guna.UI2.WinForms.Guna2Panel()
        growthBtn = New Guna.UI2.WinForms.Guna2Button()
        userGrowthChart = New Guna.Charts.WinForms.GunaChart()
        Label2 = New Label()
        Guna2Panel8 = New Guna.UI2.WinForms.Guna2Panel()
        discountStatusPie = New DataVisualization.Charting.Chart()
        Label5 = New Label()
        ...
        CType(userActTable, ComponentModel.ISupportInitialize).BeginInit()
        ...
        Guna2Panel1.Controls.Add(alluserShow)
        Guna2Panel1.Controls.Add(Guna2Button1)
        Guna2Panel1.Controls.Add(customerNum)
        Guna2Panel1.CustomizableEdges = CustomizableEdges5
        Guna2Panel1.FillColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        Guna2Panel1.Location = New Point(33, 56)
        Guna2Panel1.Name = "Guna2Panel1"
        Guna2Panel1.ShadowDecoration.CustomizableEdges = CustomizableEdges6
        Guna2Panel1.Size = New Size(270, 150)
        Guna2Panel1.TabIndex = 0
        ' 
        ' alluserShow
        ' 
        alluserShow.BackColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        alluserShow.BorderRadius = 15
        alluserShow.CustomizableEdges = CustomizableEdges1
        alluserShow.DisabledState.BorderColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        alluserShow.DisabledState.CustomBorderColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        alluserShow.DisabledState.FillColor = Color.FromArgb(CByte(220), CByte(229), CByte(219))
        alluserShow.DisabledState.Font = New Font("Century Gothic", 9F)
        alluserShow.DisabledState.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        alluserShow.FillColor = Color.FromArgb(CByte(250), CByte(249), CByte(246))
        alluserShow.Font = New Font("Century Gothic", 6.75F)
        alluserShow.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        alluserShow.ImageAlign = HorizontalAlignment.Left
        alluserShow.Location = New Point(87, 113)
        alluserShow.Name = "alluserShow"
        alluserShow.ShadowDecoration.CustomizableEdges = CustomizableEdges2
        alluserShow.Size = New Size(88, 26)
        alluserShow.TabIndex = 5
        alluserShow.Text = "Show Details"
        ' 
        ' Guna2Button1
        ' 
        ...
        Guna2Button1.DisabledState.Image = CType(resources.GetObject("resource.Image"), Image)
        ...
        Guna2Button1.Location = New Point(12, 10)
        Guna2Button1.Name = "Guna2Button1"
        Guna2Button1.ShadowDecoration.CustomizableEdges = CustomizableEdges4
        Guna2Button1.Size = New Size(107, 29)
        Guna2Button1.TabIndex = 2
        Guna2Button1.Text = "Customer"
        ...
        customerNum.Location = New Point(100, 50)
        ...
        Guna2Panel2.Controls.Add(activeShow)
        Guna2Panel2.Controls.Add(Guna2Button2)
        Guna2Panel2.Controls.Add(activeNum)
        Guna2Panel2.CustomizableEdges = CustomizableEdges11
        Guna2Panel2.FillColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        Guna2Panel2.Location = New Point(323, 56)
        Guna2Panel2.Name = "Guna2Panel2"
        Guna2Panel2.ShadowDecoration.CustomizableEdges = CustomizableEdges12
        Guna2Panel2.Size = New Size(270, 150)
        Guna2Panel2.TabIndex = 3
        ' 
        ' activeShow
        ' 
        activeShow.BackColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        activeShow.BorderRadius = 15
        activeShow.CustomizableEdges = CustomizableEdges7
        activeShow.DisabledState.BorderColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        activeShow.DisabledState.CustomBorderColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        activeShow.DisabledState.FillColor = Color.FromArgb(CByte(220), CByte(229), CByte(219))
        activeShow.DisabledState.Font = New Font("Century Gothic", 9F)
        activeShow.DisabledState.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        activeShow.FillColor = Color.FromArgb(CByte(250), CByte(249), CByte(246))
        activeShow.Font = New Font("Century Gothic", 6.75F)
        activeShow.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        activeShow.ImageAlign = HorizontalAlignment.Left
        activeShow.Location = New Point(87, 113)
        activeShow.Name = "activeShow"
        activeShow.ShadowDecoration.CustomizableEdges = CustomizableEdges8
        activeShow.Size = New Size(88, 26)
        activeShow.TabIndex = 4
        activeShow.Text = "Show Details"
        ' 
        ' Guna2Button2
        ' 
        Guna2Button2.BackColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        ...
        Guna2Button2.DisabledState.Image = CType(resources.GetObject("resource.Image1"), Image)
        ...
        ' activeNum
        ' 
        activeNum.BackColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        activeNum.Font = New Font("Century Gothic", 30F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        activeNum.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        activeNum.Location = New Point(100, 50)
        activeNum.Name = "activeNum"
        activeNum.Size = New Size(64, 47)
        activeNum.TabIndex = 2
        activeNum.Text = "35"
        activeNum.TextAlign = ContentAlignment.MiddleCenter
        ' 
        ' Guna2Panel3
        ' 
        ...
        Guna2Panel3.Controls.Add(discountShow)
        Guna2Panel3.Controls.Add(Guna2Button3)
        Guna2Panel3.Controls.Add(pendingNum)
        Guna2Panel3.CustomizableEdges = CustomizableEdges17
        Guna2Panel3.FillColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        Guna2Panel3.Location = New Point(613, 56)
        Guna2Panel3.Name = "Guna2Panel3"
        Guna2Panel3.ShadowDecoration.CustomizableEdges = CustomizableEdges18
        Guna2Panel3.Size = New Size(270, 150)
        Guna2Panel3.TabIndex = 3
        ' 
        ' discountShow
        ' 
        discountShow.BackColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        discountShow.BorderRadius = 15
        discountShow.CustomizableEdges = CustomizableEdges13
        discountShow.DisabledState.BorderColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        discountShow.DisabledState.CustomBorderColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        discountShow.DisabledState.FillColor = Color.FromArgb(CByte(220), CByte(229), CByte(219))
        discountShow.DisabledState.Font = New Font("Century Gothic", 9F)
        discountShow.DisabledState.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        discountShow.FillColor = Color.FromArgb(CByte(250), CByte(249), CByte(246))
        discountShow.Font = New Font("Century Gothic", 6.75F)
        discountShow.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        discountShow.ImageAlign = HorizontalAlignment.Left
        discountShow.Location = New Point(87, 113)
        discountShow.Name = "discountShow"
        discountShow.ShadowDecoration.CustomizableEdges = CustomizableEdges14
        discountShow.Size = New Size(88, 26)
        discountShow.TabIndex = 6
        discountShow.Text = "Show Details"
        ' 
        ' Guna2Button3
        ' 
        Guna2Button3.BackColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        Guna2Button3.BorderRadius = 10
        Guna2Button3.CustomizableEdges = CustomizableEdges15
        Guna2Button3.DisabledState.BorderColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        Guna2Button3.DisabledState.CustomBorderColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        Guna2Button3.DisabledState.FillColor = Color.FromArgb(CByte(250), CByte(249), CByte(246))
        Guna2Button3.DisabledState.Font = New Font("Century Gothic", 9F)
        Guna2Button3.DisabledState.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        Guna2Button3.DisabledState.Image = CType(resources.GetObject("resource.Image2"), Image)
        Guna2Button3.Enabled = False
        Guna2Button3.FillColor = Color.FromArgb(CByte(250), CByte(249), CByte(246))
        ...
        ' pendingNum
        ' 
        pendingNum.BackColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        pendingNum.Font = New Font("Century Gothic", 30F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        pendingNum.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        pendingNum.Location = New Point(100, 50)
        pendingNum.Name = "pendingNum"
        pendingNum.Size = New Size(64, 47)
        pendingNum.TabIndex = 2
        pendingNum.Text = "35"
        pendingNum.TextAlign = ContentAlignment.MiddleCenter
        ' 
        ' Guna2Panel4
        ' 
        ...
        Guna2Panel4.Controls.Add(signupShow)
        Guna2Panel4.Controls.Add(Guna2Button4)
        Guna2Panel4.Controls.Add(signupNum)
        Guna2Panel4.CustomizableEdges = CustomizableEdges23
        Guna2Panel4.FillColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        Guna2Panel4.Location = New Point(903, 56)
        Guna2Panel4.Name = "Guna2Panel4"
        Guna2Panel4.ShadowDecoration.CustomizableEdges = CustomizableEdges24
        Guna2Panel4.Size = New Size(270, 150)
        Guna2Panel4.TabIndex = 3
        ' 
        ' signupShow
        ' 
        signupShow.BackColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        signupShow.BorderRadius = 15
        signupShow.CustomizableEdges = CustomizableEdges19
        signupShow.DisabledState.BorderColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        signupShow.DisabledState.CustomBorderColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        signupShow.DisabledState.FillColor = Color.FromArgb(CByte(220), CByte(229), CByte(219))
        signupShow.DisabledState.Font = New Font("Century Gothic", 9F)
        signupShow.DisabledState.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        signupShow.FillColor = Color.FromArgb(CByte(250), CByte(249), CByte(246))
        signupShow.Font = New Font("Century Gothic", 6.75F)
        signupShow.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        signupShow.ImageAlign = HorizontalAlignment.Left
        signupShow.Location = New Point(87, 113)
        signupShow.Name = "signupShow"
        signupShow.ShadowDecoration.CustomizableEdges = CustomizableEdges20
        signupShow.Size = New Size(88, 26)
        signupShow.TabIndex = 7
        signupShow.Text = "Show Details"
        ' 
        ' Guna2Button4
        ' 
        ...
        Guna2Button4.DisabledState.FillColor = Color.FromArgb(CByte(250), CByte(249), CByte(246))
        ...
        Guna2Button4.DisabledState.Image = CType(resources.GetObject("resource.Image3"), Image)
        ...
        Guna2Button4.Location = New Point(12, 10)
        Guna2Button4.Name = "Guna2Button4"
        Guna2Button4.ShadowDecoration.CustomizableEdges = CustomizableEdges22
        Guna2Button4.Size = New Size(122, 29)
        Guna2Button4.TabIndex = 2
        Guna2Button4.Text = "New Signup"
        Guna2Button4.TextAlign = HorizontalAlignment.Right
        ' 
        ' signupNum
        ' 
        signupNum.BackColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        signupNum.Font = New Font("Century Gothic", 30F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        signupNum.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        signupNum.Location = New Point(100, 50)
        signupNum.Name = "signupNum"
        signupNum.Size = New Size(64, 47)
        signupNum.TabIndex = 2
        signupNum.Text = "35"
        signupNum.TextAlign = ContentAlignment.MiddleCenter
        ' 
        ' Label10
        ' 
        ...
        userAccTable.Location = New Point(18, 43)
        userAccTable.Name = "userAccTable"
        userAccTable.ReadOnly = True
        userAccTable.RowHeadersVisible = False
        userAccTable.ScrollBars = ScrollBars.None
        userAccTable.Size = New Size(525, 140)
        ...
        ' Guna2Panel6
        ' 
        Guna2Panel6.BorderColor = Color.FromArgb(CByte(110), CByte(126), CByte(124))
        Guna2Panel6.BorderRadius = 20
        Guna2Panel6.BorderThickness = 1
        Guna2Panel6.Controls.Add(userActTable)
        Guna2Panel6.Controls.Add(Label13)
        Guna2Panel6.CustomizableEdges = CustomizableEdges27
        Guna2Panel6.FillColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        Guna2Panel6.Location = New Point(613, 246)
        Guna2Panel6.Name = "Guna2Panel6"
        Guna2Panel6.ShadowDecoration.CustomizableEdges = CustomizableEdges28
        Guna2Panel6.Size = New Size(560, 200)
        Guna2Panel6.TabIndex = 6
        ' 
        ' userActTable
        ' 
        userActTable.AllowUserToAddRows = False
        userActTable.AllowUserToDeleteRows = False
        userActTable.AllowUserToResizeColumns = False
        userActTable.AllowUserToResizeRows = False
        DataGridViewCellStyle4.BackColor = Color.White
        userActTable.AlternatingRowsDefaultCellStyle = DataGridViewCellStyle4
        userActTable.BackgroundColor = Color.FromArgb(CByte(220), CByte(229), CByte(219))
        ...
        userActTable.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle5
        userActTable.ColumnHeadersHeight = 20
        ...
        userActTable.DefaultCellStyle = DataGridViewCellStyle6
        userActTable.GridColor = Color.FromArgb(CByte(110), CByte(126), CByte(124))
        userActTable.Location = New Point(18, 43)
        userActTable.Name = "userActTable"
        userActTable.ReadOnly = True
        userActTable.RowHeadersVisible = False
        userActTable.ScrollBars = ScrollBars.None
        userActTable.Size = New Size(525, 140)
        userActTable.TabIndex = 5
        userActTable.ThemeStyle.AlternatingRowsStyle.BackColor = Color.White
        userActTable.ThemeStyle.AlternatingRowsStyle.Font = Nothing
        userActTable.ThemeStyle.AlternatingRowsStyle.ForeColor = Color.Empty
        userActTable.ThemeStyle.AlternatingRowsStyle.SelectionBackColor = Color.Empty
        userActTable.ThemeStyle.AlternatingRowsStyle.SelectionForeColor = Color.Empty
        userActTable.ThemeStyle.BackColor = Color.FromArgb(CByte(220), CByte(229), CByte(219))
        userActTable.ThemeStyle.GridColor = Color.FromArgb(CByte(110), CByte(126), CByte(124))
        userActTable.ThemeStyle.HeaderStyle.BackColor = Color.FromArgb(CByte(100), CByte(88), CByte(255))
        userActTable.ThemeStyle.HeaderStyle.BorderStyle = DataGridViewHeaderBorderStyle.None
        userActTable.ThemeStyle.HeaderStyle.Font = New Font("Century Gothic", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        userActTable.ThemeStyle.HeaderStyle.ForeColor = Color.White
        userActTable.ThemeStyle.HeaderStyle.HeaightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing
        userActTable.ThemeStyle.HeaderStyle.Height = 20
        userActTable.ThemeStyle.ReadOnly = True
        userActTable.ThemeStyle.RowsStyle.BackColor = Color.White
        userActTable.ThemeStyle.RowsStyle.BorderStyle = DataGridViewCellBorderStyle.SingleHorizontal
        userActTable.ThemeStyle.RowsStyle.Font = New Font("Century Gothic", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        userActTable.ThemeStyle.RowsStyle.ForeColor = Color.FromArgb(CByte(71), CByte(69), CByte(94))
        userActTable.ThemeStyle.RowsStyle.Height = 25
        userActTable.ThemeStyle.RowsStyle.SelectionBackColor = Color.FromArgb(CByte(231), CByte(229), CByte(255))
        userActTable.ThemeStyle.RowsStyle.SelectionForeColor = Color.FromArgb(CByte(71), CByte(69), CByte(94))
        ' 
        ' Label13
        ' 
        Label13.AutoSize = True
        Label13.BackColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        Label13.Font = New Font("Century Gothic", 9.25F)
        ...
        Label11.Location = New Point(33, 457)
        ...
        ' Guna2Panel7
        ' 
        Guna2Panel7.BorderColor = Color.FromArgb(CByte(110), CByte(126), CByte(124))
        Guna2Panel7.BorderRadius = 20
        Guna2Panel7.BorderThickness = 1
        Guna2Panel7.Controls.Add(growthBtn)
        Guna2Panel7.Controls.Add(userGrowthChart)
        Guna2Panel7.Controls.Add(Label2)
        Guna2Panel7.CustomizableEdges = CustomizableEdges31
        Guna2Panel7.FillColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        Guna2Panel7.Location = New Point(33, 489)
        Guna2Panel7.Name = "Guna2Panel7"
        Guna2Panel7.ShadowDecoration.CustomizableEdges = CustomizableEdges32
        Guna2Panel7.Size = New Size(560, 200)
        Guna2Panel7.TabIndex = 7
        ' 
        ' growthBtn
        ' 
        growthBtn.BackColor = Color.Transparent
        growthBtn.BorderColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        growthBtn.BorderRadius = 15
        growthBtn.CustomizableEdges = CustomizableEdges29
        growthBtn.DisabledState.BorderColor = Color.DarkGray
        growthBtn.DisabledState.CustomBorderColor = Color.DarkGray
        growthBtn.DisabledState.FillColor = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        growthBtn.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        growthBtn.FillColor = Color.FromArgb(CByte(250), CByte(249), CByte(246))
        growthBtn.Font = New Font("Segoe UI", 9F)
        growthBtn.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        growthBtn.Location = New Point(437, 10)
        growthBtn.Name = "growthBtn"
        growthBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges30
        growthBtn.Size = New Size(106, 29)
        growthBtn.TabIndex = 6
        growthBtn.Text = "Week"
        ' 
        ' userGrowthChart
        ' 
        userGrowthChart.BackColor = Color.FromArgb(CByte(220), CByte(229), CByte(219))
        ChartFont1.FontName = "Century Gothic"
        userGrowthChart.Legend.LabelFont = ChartFont1
        userGrowthChart.Location = New Point(18, 45)
        userGrowthChart.Name = "userGrowthChart"
        userGrowthChart.PaletteCustomColors.BorderColors.AddRange(New Color() {Color.FromArgb(CByte(13), CByte(40), CByte(36))})
        userGrowthChart.PaletteCustomColors.FillColors.AddRange(New Color() {Color.FromArgb(CByte(22), CByte(66), CByte(60)), Color.FromArgb(CByte(55), CByte(90), CByte(85)), Color.FromArgb(CByte(94), CByte(130), CByte(124)), Color.FromArgb(CByte(135), CByte(173), CByte(166)), Color.FromArgb(CByte(150), CByte(177), CByte(172)), Color.FromArgb(CByte(99), CByte(124), CByte(119)), Color.FromArgb(CByte(35), CByte(48), CByte(68)), Color.FromArgb(CByte(81), CByte(94), CByte(116))})
        userGrowthChart.PaletteCustomColors.PointBorderColors.AddRange(New Color() {Color.FromArgb(CByte(22), CByte(66), CByte(60)), Color.FromArgb(CByte(55), CByte(90), CByte(85)), Color.FromArgb(CByte(94), CByte(130), CByte(124)), Color.FromArgb(CByte(135), CByte(173), CByte(166)), Color.FromArgb(CByte(150), CByte(177), CByte(172)), Color.FromArgb(CByte(99), CByte(124), CByte(119)), Color.FromArgb(CByte(35), CByte(48), CByte(68)), Color.FromArgb(CByte(81), CByte(94), CByte(116))})
        userGrowthChart.PaletteCustomColors.PointFillColors.AddRange(New Color() {Color.FromArgb(CByte(22), CByte(66), CByte(60)), Color.FromArgb(CByte(55), CByte(90), CByte(85)), Color.FromArgb(CByte(94), CByte(130), CByte(124)), Color.FromArgb(CByte(135), CByte(173), CByte(166)), Color.FromArgb(CByte(150), CByte(177), CByte(172)), Color.FromArgb(CByte(99), CByte(124), CByte(119)), Color.FromArgb(CByte(35), CByte(48), CByte(68)), Color.FromArgb(CByte(81), CByte(94), CByte(116))})
        userGrowthChart.Size = New Size(525, 138)
        userGrowthChart.TabIndex = 5
        ChartFont2.FontName = "Arial"
        ChartFont2.Size = 12
        ChartFont2.Style = Guna.Charts.WinForms.ChartFontStyle.Bold
        userGrowthChart.Title.Font = ChartFont2
        ChartFont3.FontName = "Arial"
        userGrowthChart.Tooltips.BodyFont = ChartFont3
        ChartFont4.FontName = "Arial"
        ChartFont4.Size = 9
        ChartFont4.Style = Guna.Charts.WinForms.ChartFontStyle.Bold
        userGrowthChart.Tooltips.TitleFont = ChartFont4
        userGrowthChart.XAxes.GridLines = Grid1
        ChartFont5.FontName = "Arial"
        Tick1.Font = ChartFont5
        userGrowthChart.XAxes.Ticks = Tick1
        userGrowthChart.YAxes.GridLines = Grid2
        ChartFont6.FontName = "Arial"
        Tick2.Font = ChartFont6
        userGrowthChart.YAxes.Ticks = Tick2
        userGrowthChart.ZAxes.GridLines = Grid3
        ChartFont7.FontName = "Arial"
        PointLabel1.Font = ChartFont7
        userGrowthChart.ZAxes.PointLabels = PointLabel1
        ChartFont8.FontName = "Arial"
        Tick3.Font = ChartFont8
        userGrowthChart.ZAxes.Ticks = Tick3
        ' 
        ' Label2
        ' 
        Label2.AutoSize = True
        Label2.BackColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        Label2.Font = New Font("Century Gothic", 9.25F)
        Label2.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        Label2.Location = New Point(18, 16)
        Label2.Name = "Label2"
        Label2.Size = New Size(90, 17)
        Label2.TabIndex = 4
        Label2.Text = " User Growth"
        ' 
        ' Guna2Panel8
        ' 
        Guna2Panel8.BorderColor = Color.FromArgb(CByte(110), CByte(126), CByte(124))
        Guna2Panel8.BorderRadius = 20
        Guna2Panel8.BorderThickness = 1
        Guna2Panel8.Controls.Add(discountStatusPie)
        Guna2Panel8.Controls.Add(Label5)
        Guna2Panel8.CustomizableEdges = CustomizableEdges33
        Guna2Panel8.FillColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        Guna2Panel8.Location = New Point(613, 489)
        Guna2Panel8.Name = "Guna2Panel8"
        Guna2Panel8.ShadowDecoration.CustomizableEdges = CustomizableEdges34
        Guna2Panel8.Size = New Size(270, 200)
        Guna2Panel8.TabIndex = 9
        ' 
        ' discountStatusPie
        ' 
        discountStatusPie.BackColor = Color.FromArgb(CByte(220), CByte(229), CByte(219))
        ChartArea1.BackColor = Color.FromArgb(CByte(220), CByte(229), CByte(219))
        ChartArea1.Name = "ChartArea1"
        discountStatusPie.ChartAreas.Add(ChartArea1)
        Legend1.Name = "Legend1"
        discountStatusPie.Legends.Add(Legend1)
        discountStatusPie.Location = New Point(18, 45)
        discountStatusPie.Name = "discountStatusPie"
        discountStatusPie.Palette = DataVisualization.Charting.ChartColorPalette.None
        discountStatusPie.PaletteCustomColors = New Color() {Color.FromArgb(CByte(22), CByte(66), CByte(60)), Color.FromArgb(CByte(135), CByte(173), CByte(166))}
        Series1.ChartArea = "ChartArea1"
        Series1.ChartType = DataVisualization.Charting.SeriesChartType.Pie
        Series1.Legend = "Legend1"
        Series1.Name = "Series1"
        discountStatusPie.Series.Add(Series1)
        discountStatusPie.Size = New Size(236, 138)
        discountStatusPie.TabIndex = 0
        discountStatusPie.Text = "Chart1"
        ' 
        ' Label5
        ' 
        Label5.AutoSize = True
        Label5.BackColor = Color.FromArgb(CByte(196), CByte(218), CByte(212))
        Label5.Font = New Font("Century Gothic", 9.25F)
        Label5.ForeColor = Color.FromArgb(CByte(13), CByte(40), CByte(36))
        Label5.Location = New Point(18, 16)
        Label5.Name = "Label5"
        Label5.Size = New Size(106, 17)
        Label5.TabIndex = 5
        Label5.Text = "Discount Status"
        ' 
        ' Guna2Panel9
        ' 
        Guna2Panel9.BorderColor = Color.FromArgb(CByte(110), CByte(126), CByte(124))
        ...
        Guna2Panel9.Size = New Size(270, 200)
        ...
        Label3.Font = New Font("Century Gothic", 9.25F)
        ...
        CType(userActTable, ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents customerShow As Label
    Friend WithEvents Guna2Button1 As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents Guna2Panel2 As Guna.UI2.WinForms.Guna2Panel
    Friend WithEvents Guna2Button2 As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents activeNum As Label
    Friend WithEvents Guna2Panel3 As Guna.UI2.WinForms.Guna2Panel
    Friend WithEvents Guna2Button3 As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents pendingNum As Label
    Friend WithEvents Guna2Panel4 As Guna.UI2.WinForms.Guna2Panel
    Friend WithEvents Guna2Button4 As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents signupNum As Label
    ...
    Friend WithEvents userActTable As Guna.UI2.WinForms.Guna2DataGridView
    Friend WithEvents Label2 As Label
    Friend WithEvents userGrowthChart As Guna.Charts.WinForms.GunaChart
    Friend WithEvents growthBtn As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents Label5 As Label
    Friend WithEvents discountStatusPie As DataVisualization.Charting.Chart
    Friend WithEvents activeShow As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents alluserShow As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents discountShow As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents signupShow As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents Label3 As Label
    Friend WithEvents userStatusPie As DataVisualization.Charting.Chart
